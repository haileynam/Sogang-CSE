...
thread_yield (void) 
{
  ...
  if (cur != idle_thread) {
    ...
    list_insert_ordered(&ready_list, &cur->elem, comparison_priority, NULL);
  }
...
thread_set_nice (int nice UNUSED) 
{
  ...
  int cur_priority = cur->priority;
  cur->nice = nice;
  // priority = PRI_MAX - (recent cpu / 4) - (nice *2)
...
/* Project 3 */
bool 
comparison_priority (const struct list_elem *a, const struct list_elem *b, void *aux)
{
