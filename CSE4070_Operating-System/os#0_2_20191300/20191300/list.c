...
// struct list_elem* 
// list_nth_element(struct list *list, size_t n)
// {
// 	struct list_elem *e;
// 	e = list_begin(list);
// 	size_t i = 0;
// 	while (i < n&&e != list_end(list))
// 	{
// 		++i;
// 		e = list_next(e);
// 	}
...
{
	size_t list_num = list_size(list);
  int num1=0, num2=0;
  // srand((unsigned int)time(NULL));
  num1 = rand()%list_num;
  num2 = rand()%list_num;
  // printf("srand check1 %d\n", num1);
  // printf("srand check2 %d\n", num2);

  if(num1==num2){
    num1 = rand()%list_num;
    num2 = rand()%list_num;
    // printf("2nd srand check1 %d\n", num1);
    // printf("2nd srand check2 %d\n", num2);
  }
  struct list_elem *e1, *e2 = list_head(list);
	int cnt=0;
  while(cnt<=num1){
    e1 = e1->next;
    cnt++;
